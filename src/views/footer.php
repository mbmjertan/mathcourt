 <?php if(isset($_COOKIE['mathcourt_cookie']) && !isset($_COOKIE['mathcourt_noanalytics'])){
 	?>
 	<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-151975508-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-151975508-1');
</script>
<?php
} ?>
<div class="container">
